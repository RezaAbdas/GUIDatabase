...
public class AdminLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tombolloginadmin = new javax.swing.JButton();
        ...
        id.setForeground(new java.awt.Color(69, 183, 183));
        id.setBorder(null);
        ...
        jLabel4.setForeground(new java.awt.Color(69, 183, 183));
        jLabel4.setText("Login Password");

        password.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        password.setForeground(new java.awt.Color(69, 183, 183));
        password.setBorder(null);

        tombolloginadmin.setBackground(new java.awt.Color(69, 183, 183));
        tombolloginadmin.setFont(new java.awt.Font("Calibri", 1, 36)); // NOI18N
        tombolloginadmin.setForeground(new java.awt.Color(232, 250, 224));
        tombolloginadmin.setText("LOGIN");
        tombolloginadmin.setBorder(null);
        tombolloginadmin.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        tombolloginadmin.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tombolloginadminActionPerformed(evt);
            }
        });

        jPanel4.setBackground(new java.awt.Color(69, 183, 183));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(105, 105, 105)
                        .addComponent(tombolloginadmin, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGap(67, 67, 67)
                .addComponent(tombolloginadmin, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(45, 45, 45))
        );

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 0, 350, 500));

        jPanel1.setBackground(new java.awt.Color(69, 183, 183));
        ...
        jLabel6.setText("di login Admin");
    ...
    private void tombolloginadminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tombolloginadminActionPerformed
        try {
            Connection con = Koneksi.configDB(); //buat koneksi
            Statement s = con.createStatement(); //buat statement untuk menampung query sql

            String sql = "SELECT * FROM login_admin where id= '" + id.getText() + "' and password ='" + password.getText() + "'"; //query sql untuk mendapatkan id dan password
...
//                JOptionPane.showMessageDialog(this, "Login Succcess");
                ...
                AdminPilihMenu adminhome = new AdminPilihMenu(); //akan dialihkan ke jendela adminCRUD jika login sukses 
    ...
    }//GEN-LAST:event_tombolloginadminActionPerformed
    ...
    private javax.swing.JButton tombolloginadmin;
